...
#' @importFrom utils capture.output read.csv write.csv setTxtProgressBar txtProgressBar write.table packageVersion packageDescription menu combn
...
setClassUnion("table_or_null"       , c("table"       , "NULL"))
